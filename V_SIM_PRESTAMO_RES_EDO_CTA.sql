  ...
  CREATE OR REPLACE FORCE VIEW "V_SIM_PRESTAMO_RES_EDO_CTA" ("CVE_GPO_EMPRESA", "CVE_EMPRESA", "ID_PRESTAMO", "DESC_MOVIMIENTO", "IMP_DEBE_TOTAL", "IMP_PAGO_TOTAL", "IMP_SALDO_TOTAL", "IMP_DEBE_HOY", "IMP_PAGO_HOY", "IMP_SALDO_HOY") AS 
  ...
  FROM V_SIM_PRESTAMO_MOV_EDO_CTA A,
    PFIN_PARAMETRO B
